...
//    }
	...
	public void testGetProperties1() throws Exception {
		try {
			System.setProperty(CommonConstants.IRIS_PROPERTIES_KEY, "properties.load");
			...
			System.clearProperty(CommonConstants.IRIS_PROPERTIES_KEY);
		}
	}
	...
	public void testGetProperties2() throws Exception {
		System.clearProperty(CommonConstants.IRIS_PROPERTIES_KEY);
		Properties p = ConfigUtils.getProperties();
		assertThat((String) p.get("iris"), equalTo("properties"));
	}
	...
	public void testGetProperty() throws Exception {
		assertThat(ConfigUtils.getProperty("iris"), equalTo("properties"));
	}
	...
	public void testGetPropertyFromSystem() throws Exception {
		try {
			System.setProperty("iris", "system");
			assertThat(ConfigUtils.getProperty("iris"), equalTo("system"));
		} finally {
			System.clearProperty("iris");
		}
	}
	...
	public void testGetSystemProperty() throws Exception {
		try {
			System.setProperty("iris", "system-only");
			assertThat(ConfigUtils.getSystemProperty("iris"), equalTo("system-only"));
		} finally {
			System.clearProperty("iris");
		}
	}
	...
	public void testLoadProperties() throws Exception {
		Properties p = ConfigUtils.loadProperties("iris.properties");
		assertThat((String) p.get("iris"), equalTo("properties"));
	}
	...
	public void testLoadPropertiesOneFileNotRootPath() throws Exception {
		Properties p = ConfigUtils.loadProperties("META-INF/iris/internal/cn.iris.cloud.common.threadpool.ThreadPool", false);

		Properties expected = new Properties();
		expected.put("fixed", "cn.iris.cloud.common.threadpool.support.fixed.FixedThreadPool");
		expected.put("cached", "cn.iris.cloud.common.threadpool.support.cached.CachedThreadPool");
		expected.put("limited", "cn.iris.cloud.common.threadpool.support.limited.LimitedThreadPool");
		expected.put("eager", "cn.iris.cloud.common.threadpool.support.eager.EagerThreadPool");
	...
	public void testLoadPropertiesMultiFileNotRootPath() throws Exception {
		...
		Properties p = ConfigUtils.loadProperties("META-INF/iris/internal/cn.iris.cloud.common.status.StatusChecker", true);

		Properties expected = new Properties();
		expected.put("memory", "cn.iris.cloud.common.status.support.MemoryStatusChecker");
		expected.put("load", "cn.iris.cloud.common.status.support.LoadStatusChecker");
		expected.put("aa", "12");
	...
	public void testPropertiesWithStructedValue() throws Exception {
		...
		Properties expected = new Properties();
		expected.put("iris.parameters", "[{a:b},{c_.d: r*}]");
