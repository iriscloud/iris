...
import cn.iris.cloud.common.extension.adaptive.HasAdaptiveExt;
import cn.iris.cloud.common.utils.IOUtils;
...
public class AdaptiveClassCodeGeneratorTest {
	...
	public void testGenerate() throws IOException {
		...
		URL url = getClass().getResource("/cn/iris/cloud/common/extension/adaptive/HasAdaptiveExt$Adaptive");
