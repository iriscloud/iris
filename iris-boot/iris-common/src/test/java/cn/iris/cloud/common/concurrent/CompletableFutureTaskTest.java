 ...
 */
package cn.iris.cloud.common.concurrent;
...
public class CompletableFutureTaskTest {
	...
	private static final ExecutorService executor = new ThreadPoolExecutor(0, 10, 60L, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), new NamedThreadFactory("IrisMonitorCreator", true));
