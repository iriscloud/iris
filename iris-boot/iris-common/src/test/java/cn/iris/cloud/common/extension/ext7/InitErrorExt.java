 ...
 */
package cn.iris.cloud.common.extension.ext7;

import cn.iris.cloud.common.URL;
import cn.iris.cloud.common.extension.SPI;

/**
 * Test scenario for cloud-144: extension load failure when third-party dependency doesn't exist. If extension is not
