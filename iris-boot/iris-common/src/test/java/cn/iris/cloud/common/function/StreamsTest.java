...
public class StreamsTest {
	...
	public void testFilterStream() {
		Stream<Integer> stream = Streams.filterStream(asList(1, 2, 3, 4, 5), i -> i % 2 == 0);
		assertEquals(asList(2, 4), stream.collect(toList()));
	}

	@Test
	public void testFilterList() {
		List<Integer> list = Streams.filterList(asList(1, 2, 3, 4, 5), i -> i % 2 == 0);
		assertEquals(asList(2, 4), list);
	}

	@Test
	public void testFilterSet() {
		Set<Integer> set = Streams.filterSet(asList(1, 2, 3, 4, 5), i -> i % 2 == 0);
