...
import cn.iris.cloud.common.config.Configuration;
import cn.iris.cloud.common.config.InmemoryConfiguration;
import cn.iris.cloud.common.constants.CommonConstants;
import cn.iris.cloud.common.utils.ArrayUtils;
import cn.iris.cloud.common.utils.CollectionUtils;
import cn.iris.cloud.common.utils.NetUtils;
import cn.iris.cloud.common.utils.StringUtils;
...
//import static cn.iris.cloud.common.convert.Converter.convertIfPossible;
 ...
 * <li>registry://192.168.1.7:9090/cn.iris.cloud.service1?param1=value1&amp;param2=value2
 * </ul>
 * <p>
...
//    }
	...
	public boolean equals(Object obj) {
		...
		URL other = (URL) obj;
		if (!StringUtils.equals(host, other.host)) {
			return false;
		}
		if (parameters == null) {
