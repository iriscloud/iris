...
public class NetUtils {
	 ...
	 * the property value from {@link CommonConstants#IRIS_PREFERRED_NETWORK_INTERFACE}, return <code>true</code>,
	 * or <code>false</code>
	 */
	public static boolean isPreferredNetworkInterface(NetworkInterface networkInterface) {
		String preferredNetworkInterface = System.getProperty(CommonConstants.IRIS_PREFERRED_NETWORK_INTERFACE);
